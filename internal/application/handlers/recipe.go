...
func (rh *recipeHandler) Update(ingredients, checklist []string, rating string, recipeId int64) error {
	if err := rh.repo.RecipeStore.Update(ingredients, checklist, rating, recipeId); err != nil {
		return err
	}
